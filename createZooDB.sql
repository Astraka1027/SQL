...
BEGIN
	...
	INSERT INTO tbl_care
		...
		('care_1', 'repare or replace broken toys', 4),
		('care_2', 'bottle feed viatmins', 1),
	...
	CREATE TABLE tbl_habitat (
		habitat_ INT PRIMARY KEY NOT NULL IDENTITY (5000,1),
	...
	sp_rename 'tbl_habitat.habitat_', 'habitat_id', 'COLUMN';
	...
	INSERT INTO tbl_persons
		...
		VALUES
		('bob','smith','232-545-5769'),
		('mary','ann','232-545-5767'),
		('tex','burns','232-545-5768'),
		('gerry','smith','232-545-5769'),
		('sally','fields','232-545-5761')
	;
